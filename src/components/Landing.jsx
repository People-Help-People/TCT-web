...
export default function Landing({ isServerInfo }) {
  ...
  return (
    <div style={{width:"70%" }}>
      ...
      <div style={{display:"flex", flexDirection:"row", gap:"50px",marginTop: '40px', marginBottom: '10px'}}>
        <Image
        ...
        /> 
        <List title="NFT info"  >
          <List.Item label="Name"><b>Name:</b> {"my NFT"}</List.Item>
          <List.Item label="Symbol"><b>Symbol:</b> {"NFTv2"}</List.Item>
          <List.Item label="Block Height"><b>Block Height:</b> {"203033"}</List.Item>
          <List.Item label="Creator"><b>Creator:</b> <a href="/">HarishTeens</a></List.Item>
